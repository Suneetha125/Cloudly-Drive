...
- **Account Privacy:** Full Account Deletion feature that recursively wipes user data from both MongoDB and Supabase S3 buckets.
...
- **Smart Trash:** Two-stage deletion process (Move to Trash vs. Permanent Delete).
- **Breadcrumb Navigation:** Dynamic path tracking for instant "Easy Back" folder navigation.
